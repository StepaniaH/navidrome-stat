...
- Revisit outbound scrobble forwarding after the ListenBrainz-compatible receiver has been used in production. Any forwarding support must be opt-in per user and keep collection sources separate.
