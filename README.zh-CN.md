...
- 外观支持跟随系统、深色和浅色三种模式，以及 9 个配色家族、13 个具体变体。内置、Gruvbox、Catppuccin、Solarized 均有深浅变体；Nord、Dracula、Tokyo Night、Macchiato、Mocha 仅支持深色。选择只保存在当前浏览器，并同步应用于统计页、年度回顾、设置和 API 文档；另提供七种界面语言。
