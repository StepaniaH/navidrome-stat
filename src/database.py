...
Schema and migrations live in :mod:`src.schema`; this module keeps the write
helpers and query layer together behind one stable import surface.
"""
...
from src.schema import (  # noqa: F401  (re-exported for callers)
    LEGACY_SOURCE_ID,
    LEGACY_SOURCE_NAME,
    PAYLOAD_BYTES_SQL,
    SCHEMA_VERSION,
...
# Backwards-compatible alias; new code should read ``config.DATABASE_PATH``.
